            ...
            <div class="card card-body">
                ...
                <div class="col-md-8 m-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{url('/faculty/store')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    <input type="text" name="f_id" required placeholder="Enter ID,must be FA-***" class="form-control">
                                </div>
                                <div class="form-group">
                            ...
                            <table class="table">
                                ...
                                @forelse($faculties as $faculty)
                                    <tr>
                                        ...
                                        <td>{{$faculty->email}}</td>
                                        <td>{{$faculty->I_SID}}</td>
                                        <td>{{$faculty->I_phone}}</td>
                                        <td>{{$faculty->I_gender}}</td>
                                        ...
                                        <td>
                                            <a href="{{url('/edit/faculty/'.$faculty->id)}}"><i
                                                        class="fa fa-pencil text-success"></i></a>
                                            <a href="#"
                                               onclick="deleteConfirm('{{url('/delete/faculty/'.$faculty->id)}}')"><i

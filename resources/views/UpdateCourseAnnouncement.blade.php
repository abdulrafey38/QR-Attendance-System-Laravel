    ...
    <div id="course-sec" class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">Update Course Related
                    Material</h1>
            </div>
        </div>
        <!--/.HEADER LINE END-->
        ...
        <ul class="breadcrumb" data-scroll-reveal="enter from the bottom after 0.4s">
            <li>Portal</li>
            <li>Course</li>
            <li>Update Course Related Material</li>
        </ul>
        <!--/.BREADCRUMB END-->
        ...
        <div id="Student-sect">
            <div class="container set-pad">
                ...
                <div class="row" data-scroll-reveal="enter from the bottom after 0.4s">
                    <form method="POST" action="{{url('add_CA/'.$course_id)}}" style="width:800px; padding-left:350px;">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="Name">Name: </label>
                            <input name="name" type="text" class="form-control name" required="required"
                                   placeholder="Name of Course Related Material"/>
                        </div>
                        <div class="form-group">
                            <label for="Announcement">Type of Announcement: </label>
